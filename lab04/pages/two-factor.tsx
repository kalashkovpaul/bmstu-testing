          ...
          .then(async decoded => {
            ...
            if (
              ...
              await prisma.user.update({
                ...
                data: {
                  twoFactorToken: null,
                  password: (context.query.updated as string),
                },
              })
    ...
    return (
      <Flex h="100vh" w="100vw" justifyContent={'center'} alignItems="center">
        ...
        >
          ...
          <AlertDescription id="2fa-invitation" maxWidth="sm">
    ...
    return (
      <Flex h="100vh" w="100vw" justifyContent={'center'} alignItems="center">
        ...
        >
          ...
          <AlertDescription id="2fa-success" maxWidth="sm">
            You have successfully changed your password. You will be redirected to
